...
export default function Footer() {
    ...
    return <div>
        ...
        <div id="mobile"
            ...
            {/* chat */}
            <NavLink exact to='/chat' activeClassName='text-blue-300'>
            ...
            {/* settings */}
            <NavLink exact to='/settings' activeClassName='text-blue-300'>
        ...
        {/* Desktop footer*/}
        <div id="desktop" className="hidden lg:block w-full bg-red-300 object-bottom bottom-0 fixed text-center text-white p-2 mt-3">Desktop</div>
    </div>
}